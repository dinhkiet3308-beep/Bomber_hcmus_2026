...
1. Cần cải thiện trường hợp khi agent rơi vào trạng thái gặp danger_soon:
   - Không trả về danger_soon nữa mà trả về danger_time (còn bao nhiêu lượt tìm bom nổ) (ĐÃ XONG)
     
2. Cần tạo thêm hàm để agent xử lý trường hợp gặp chain reaction (bom chồng bom) (ĐÃ XONG)
